...
Framework & Next.js 16.2.11 (App Router) & Routing, Server Components, Server Actions, the Route Handlers under \pathcell{src/app/api} (\pathcell{/api/digest}, \pathcell{/api/books}). \textbf{Not} the Next.js of most tutorials — see Chapter~\ref{ch:welcome}'s warning. \\
