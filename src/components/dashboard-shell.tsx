...
export default function DashboardShell({
  ...
  return (
    <div className="min-h-screen bg-cream text-slate-900 md:flex">
      ...
      <div
        className={[
          'fixed inset-y-0 left-0 z-50 bg-cream',
      ...
      >
        ...
        <button
          onClick={() => setOpen(false)}
          className="md:hidden absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-slate-50 hover:bg-slate-100 text-slate-600 hover:text-slate-900 transition-colors"
